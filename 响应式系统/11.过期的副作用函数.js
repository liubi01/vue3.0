  ...
  // }
  // effect()
  let tmp1, tmp2, finalData;
  //   watch(obj, (nVal, oVal) => {
  //       console.log('值改变了', nVal, oVal);
  //   })
  watch(() => obj.foo, async (nVal, oVal, onInvalidate) => {
      // document.body.innerText = nVal
      let expired = false;
      onInvalidate(() => {
          expired = true;
      })
      ...
      // immediate:true,
      // flush:'pre' // vue3.0的新属性：pre组件更细前 post 组件更新后
  })
